angular.module("imx.colorpicker", ['angular-carousel', 'ngScrollbar']);;angular.module("imx.colorpicker").directive('imxColor', ['imxPaletteService', function factory(paletteService) {
    return {
        restrict: 'A',
        scope: {
            instColor: "@imxColor"
